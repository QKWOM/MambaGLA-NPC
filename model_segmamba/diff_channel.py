...
class SegMamba(nn.Module):
    def __init__(
        ...
        self.gating2 = UnetGridGatingSignal3(feat_size[2], feat_size[1], kernel_size=(3, 3, 3), is_batchnorm=True)
        self.gating1 = UnetGridGatingSignal3(feat_size[1], feat_size[0], kernel_size=(3, 3, 3), is_batchnorm=True)
