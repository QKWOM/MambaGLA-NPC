...
class SegMamba(nn.Module):
    def __init__(
        ...
        self.stem = nn.Conv3d(1, 24, kernel_size=1)
        ...
        self.out_0 = OutBlock(in_channels=24, n_classes=self.in_chans, dim=self.dim)
    ...
    def forward(self, x_in):
        ...
        outs = self.vit(x_in)
        # print(x_in.shape)
        enc1 = self.enc_block_0(x_input) # 24xDxHxW
        ...
        x_up_0 = self.up_0(x) # 24xDxHxW
        dec_x = enc1 + x_up_0 # 24xDxHxW
        x = self.dec_block_0(dec_x) # 24xDxHxW
